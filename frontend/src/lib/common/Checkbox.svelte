...
<label class="select-none cursor-pointer px-4 py-2 rounded border {checked ? 'text-accent bg-accent/5 border-accent' : 'border-gray-200 bg-gray-100 opacity-70 hover:opacity-100'} ">
