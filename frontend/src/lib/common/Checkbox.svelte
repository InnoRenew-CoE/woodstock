...
<label class="font-nunito select-none cursor-pointer px-4 py-2 rounded border {checked ? 'bg-secondary/5 text-secondary border-secondary ' : 'border-gray-200 bg-gray-100 opacity-70 hover:opacity-100'} ">
