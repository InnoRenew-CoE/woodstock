...
<div class="flex flex-wrap h-full gap-5 items-center justify-center">
    <form class="glass flex flex-col gap-5 p-10 w-[90%] max-w-[800px]" onsubmit={submit}>
        <div class="glass p-5">
        ...
        <div class="flex items-center justify-end py-3">
            <button type="submit" class="transition-all cursor-pointer hover:bg-secondary/90 hover:text-white rounded-lg glass px-5 py-2">Submit</button>
        </div>
